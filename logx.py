...
class Logger:
    ...
    state of a training run, and the trained model_1.
    """
    ...
    def save_state(self, state_dict, itr=None):
        ...
        environment---and the most recent parameters for the model_1 you
    ...
    def setup_tf_saver(self, sess, inputs, outputs):
        """
        Set up easy model_1 saving for tensorflow.
